...
registrations = {
    'google': {
        ...
        'client_id': os.environ.get('MUTT_OAUTH2_GOOGLE_CLIENT_ID'),
        'client_secret': os.environ.get('MUTT_OAUTH2_GOOGLE_CLIENT_SECRET'),
    },
    'microsoft': {
        ...
        'client_id': os.environ.get('MUTT_OAUTH2_MS_CLIENT_ID'),
        'client_secret': os.environ.get('MUTT_OAUTH2_MS_CLIENT_SECRET'),
    },
}
...
ap.add_argument('-r', '--registration', help='google|microsoft')
ap.add_argument('-e', '--email', help='account email')
args = ap.parse_args()
...
def writetokenfile():
    ...
    token_data = json.dumps(token).encode()
    path.write_bytes(token_data)
